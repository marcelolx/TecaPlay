...
public class HomePage {
	...
	*/
	public HomePage(String usrName) {
		...
		// criado painel aonde ficar–≥o os botoes para a escolha de musica,
		// video
		// ou imagem
		...
		btnEstilosMusica.setToolTipText("OpÁ„o de acesso a aba dos Favoritos!");
		 ...
		 * 
		 * 
		 * FILMES/CAREGORIAS Painel de categorias que ser–± chamado ao apertar
		...
		JButton btnMusicAxe = new JButton("AxÈ");
		btnMusicAxe.setToolTipText("Categoria AxÈ.");
		...
		JButton btnMusicEletronica = new JButton("EletrÙnica");
		btnMusicEletronica.setToolTipText("Categoria Com\u00E9dia EletrÙnica.");
		...
		JButton btnMusicForro = new JButton("ForrÛ");
		btnMusicForro.setToolTipText("Categoria ForrÛ.");
		...
		JButton btnMusicFolcloricas = new JButton("FolclÛricas");
		btnMusicFolcloricas.setToolTipText("Categoria FolclÛricas.");
		...
		JButton btnMusicRomantica = new JButton("Rom‚ntica");
		btnMusicRomantica.setToolTipText("Categoria Rom‚ntica.");
		...
		/*
		 * A–ó–ìO DE BUTTONS A–ó–ìO DE BUTTONS A–ó–ìO DE BUTTONS A–ó–ìO DE
		 * BUTTONS TODO
		 */
		...
		btnCatAnimacao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (ler) {
					...
					home.add(voltarPaineis.get(1), BorderLayout.CENTER);
					// adiciona o JTable e chama os mÈtodos para listar os
					// filmes.
					listFiles.reUpdateTable(table, usrName, currentGenre);
					tableContainer.setPreferredSize(new Dimension(790, 500));
