...
public class HomePage {
	...
	*/
	public HomePage(String usrName) {
		...
		menuAjuda.setIcon(new ImageIcon("resources\\images\\imgMenuSobre.png")); // adiзг
		...
		// criado painel aonde ficarгo os botoes para a escolha de musica, video
		// ou imagem
		...
		/**
		 * criaзгo de botoes video/musica/imagem
		 */
		...
		JButton btnMusica = new JButton("Mъsica");
		...
		/**
		 * 
		 * Adiзгo de Painel Lateral para abrigar os botoes de gerenciar o que
		 * serб apresentado
		 * 
		 * 
		 * Imagem LATERAL
		...
		JButton btnColecaoImagem = new JButton("Listar Coleзгo");
		btnColecaoImagem.setToolTipText("Op\u00E7\u00E3o de acesso a aba Coleзгo!");
		...
		// Aзгo que serб realizada ao apertar o botao de Imagem do jpanelTopo
		...
		// Aзгo que serб realizada ao apertar o botao de Musica do jpanelTopo
		 ...
		 * 
		 * 
		 * FILMES/CAREGORIAS Painel de categorias que serб chamado ao apertar no
		 * jbutton btnFilmes
		 * 
		 * 
		 * TODO
		...
		btnCatComedia.setToolTipText("Categoria Comйdia.");
		...
		btnCatDocumentario.setToolTipText("Categoria Documentбrio.");
		...
		btnCatFicaoCient.setToolTipText("Categoria Ficзгo Cientнfica.");
		...
		btnCatAventuraSerie.setToolTipText("Categoria Aзгo.");
		...
		btnCatDocumentarioSerie.setToolTipText("Categoria Documentбrio.");
		...
		JButton btnCatFicaoCientSerie = new JButton("<html><center>Ficção</br> Cientifica</center></html>");
		btnCatFicaoCientSerie.setToolTipText("Categoria Ficзгo Cientнfica.");
		...
		/*
		 * AЗГO DE BUTTONS AЗГO DE BUTTONS AЗГO DE BUTTONS AЗГO DE BUTTONS TODO
		 */
		...
		// Aзгo ao clicar no button lateral Filmes
		...
		//
		// Aзгo do botгo filmes categoria Aзгo
		...
		// Aзгo do botгo filmes categoria Animaзгo
		btnCatAnimacao.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (ler) {
					...
					home.add(voltarPaineis.get(1), BorderLayout.CENTER);
					//adiciona o JTable e chama os m�todos para listar os filmes.
					listFiles.reUpdateTable(table, usrName, currentGenre);
					tableContainer.setPreferredSize(new Dimension(790, 500));
					...
					JOptionPane.showMessageDialog(null, "Nгo а nada a ser listado", "Invalido", 0);
				}

			}
		});

		// Aзгo do botгo filmes categoria Aventura
		btnCatAventura.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (ler) {
					...
					JOptionPane.showMessageDialog(null, "Não а nada a ser listado", "Invбlido", 0);
				}

			}
		});

		// Aзгo do botгo filmes categoria Classico
		btnCatClassico.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (ler) {
					...
					JOptionPane.showMessageDialog(null, "Nгo а nada a ser listado", "Invбlido", 0);
				}
			}
		});

		// Aзгo do botгo filmes categoria Comedia
		...
		// Aзгo do botгo filmes categoria ComediaRomantica
		...
		// Aзгo do botгo filmes categoria Crime
		...
		// Aзгo do botгo filmes categoria Documentario
		...
		// Aзгo do botгo filmes categoria Drama
		...
		// Aзгo do botгo filmes categoria Faroeste
		...
		// Aзгo do botгo filmes categoria FiccaoCientifica
		...
		// Aзгo do botгo filmes categoria Guerra
		...
		// Aзгo do botгo filmes categoria Musical
		...
		// Aзгo do botгo filmes categoria Policial
		...
		// Aзгo do botгo filmes categoria Romance
		...
		// Aзгo do botгo filmes categoria Suspense
		...
		// Aзгo do botгo filmes categoria Terror
		...
		// Aзгo do botгo filmes categoria Thriller
		...
		// Aзгo do botгo filmes categoria Anime
